...
namespace _1_Mathematics
{
    class _5_HCF
    {
        public static int Calculate_Naive(int input1, int input2)
        {
            int result = 1;
        ...
        public static int Calculate_EuclideanAlgo(int input1, int input2)
        {
            while (input1 != input2)
            {
                if (input1 > input2)
        ...
        public static int Calculate_EuclideanAlgoOptimized(int input1, int input2)
        {
            while (input2 == 0)
            {
                int temp = input2;
