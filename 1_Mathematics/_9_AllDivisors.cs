...
{
    class _9_AllDivisors
    {
        public static void Calculate_Naive(int input)
        {
        ...
        public static void Calculate_Optimize_NotSorted(int input)
        {
            if (input == 0) return;
        ...
        public static void Calculate_Optimize_Sorted(int input)
        {
            if (input == 0) return;
            int i;
